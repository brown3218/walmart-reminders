...
`npm run doctor` checks Node, config, SQLite, Walmart session/manual-action status, Reminders helper status, Walmart profile directory, dashboard reachability, and LAN URL detection.
